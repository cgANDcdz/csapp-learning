...
static char *mem_heap;     /* Points to first byte of heap => 指向堆底部*/ 
static char *mem_brk;      /* Points to last byte of heap plus 1 => 指向堆顶部*/
static char *mem_max_addr; /* Max legal heap addr plus 1 =>指向堆的最大合法位置*/ 
