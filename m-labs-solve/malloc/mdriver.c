...
/****************************************************************************************
 *  The mdriver.c program is a driver program that allows you to evaluate the performance
 *  of your solution. Use the command make to generate the driver code and run it with the
 *  command ./mdriver -V. (The -V flag displays helpful summary information.)
 ****************************************************************************************/
